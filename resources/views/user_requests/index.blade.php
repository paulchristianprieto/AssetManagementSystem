							...
							<div class="card-header" id="headingOne">
								<div class="row">
									...
									<div class="col-3 text-center">
										...
										<span>
											<a href="{{ route('user_requests.edit', ['user_request' => $request->id])}}" class="btn btn-dark btn-raised bg-success">Mark as Returned</a>
										</span>
						...
						<div class="card shadow bg-white rounded">
							<div class="card-header" id="headingOne">
								<div class="row">
									...
									<div class="col-3 text-center">
										<span>
											<a href="{{ route('request_approve', ['user_request'=>$request->id]) }}" class="btn btn-dark btn-raised bg-info">Approve</a>
										</span>
